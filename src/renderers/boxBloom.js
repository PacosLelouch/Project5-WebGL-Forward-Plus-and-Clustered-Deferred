...
import BoxBloomFragSource from '../shaders/boxBloom.frag.glsl';

export default class BoxBloom {
    constructor(radius = 0) {
        this.radius = radius;
        this._width = canvas.width
        this._height = canvas.height;

        this._progPostProcessing = loadShaderProgram(QuadVertSource, BoxBloomFragSource, {
